<?php
  ...
  elseif(isset($_GET['code'])) {
    $url = "https://graph.facebook.com/oauth/access_token?client_id=" . Config::get()->fb_app_id . "&redirect_uri=http://tdp013.gyllingdata.se/test.php&client_secret=" . Config::get()->fb_secret . "&code={$_GET['code']}";
